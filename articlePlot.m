function [] = articlePlot()
  ...
  if( index == 1 )
    ...
    semilogy( 0:iter_count, backward_error, "-", "linewidth", 3, "color", "k" );
    hold on;
    semilogy( 0:iter_count, true_residual, "--", "linewidth", 3, "color", "k" );
    semilogy(  0:iter_count,forward_error, "-.", "linewidth", 3, "color", "k" );
    semilogy(  0:iter_count,updated_residual, ":", "linewidth", 1.5, "color", "k" );
    ...
    semilogy( 0:iter_count, backward_error, "-", "linewidth", 1.5, "color", "k" );
    semilogy( 0:iter_count, true_residual, "--", "linewidth", 1.5, "color", "k" );
    %semilogy( updated_residual );
    semilogy( 0:iter_count, forward_error, "-.", "linewidth", 1.5, "color", "k" );
    hold off;
    axis([0 iter_count]);
  ...
  if( index == 2 )
    ...
    semilogy( 0:t, backward_error, "-", "linewidth", 3, "color", "k" );
    hold on;
    semilogy( 0:t, true_residual, "--", "linewidth", 3, "color", "k" );
    semilogy(  0:t,forward_error, "-.", "linewidth", 3, "color", "k" );
    semilogy(  0:t,updated_residual, ":", "linewidth", 1.5, "color", "k" );
    ...
    t = length(backward_error)-1;    
    semilogy( 0:t, backward_error, "-", "linewidth", 1.5, "color", "k" );
    semilogy( 0:t, true_residual, "--", "linewidth", 1.5, "color", "k" );
    semilogy( 0:t, forward_error, "-.", "linewidth", 1.5, "color", "k" );
    hold off;
    axis([0 t]);
    legend('Location','southoutside');
    legend('boxoff');
